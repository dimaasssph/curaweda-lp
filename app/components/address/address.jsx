...
export const Address = ({ data }) => {
    ...
    const instagram = data.find((a) => a.key === "instagram")
    const linkedin = data.find((a) => a.key === "linkedin")
    return (
        <div className="p-10">
            ...
            <div className="ml-4">
                ...
                <div className="flex w-full">
                    <Link href={instagram.value} target="_blank" >
                        <div className="w-10 mr-5 transition-all hover:scale-125">
                    ...
                    <Link href={linkedin.value} target="_blank">
                        <div className="w-10 mr-5 transition-all hover:scale-125">
