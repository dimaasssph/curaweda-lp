...
export const Card = ({ item }) => {
    return (
        <div class="relative flex flex-col mt-6 text-gray-700 bg-transparent hover:shadow-md bg-clip-border rounded-xl pt-10 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-[#3C7083] hover:text-white duration-400 min-w-300">
            ...
            <div class="p-6 flex flex-col justify-between">
                <h5 class="block mb-2 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900" dangerouslySetInnerHTML={{ __html: item.title }} />
