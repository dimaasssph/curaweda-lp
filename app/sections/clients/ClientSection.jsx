        ...
        <div className="pt-5">
            ...
            <div className="w-full p-[100px] flex flex-wrap flex-grow align-middle justify-center space-x-3 space-y-3">
                {data.map((image, index) => (
                    <figure class="max-w-lg" key={index}>
                        <img key={index} data-aos="fade-up" data-aos-duration="2500" class="h-auto w-28 rounded-lg" src={image} alt="image description" />
                    </figure>
                ))}
            </div>
            ...
            <div className="w-full p-[100px] flex flex-wrap flex-grow align-middle justify-center space-x-3 space-y-3">
                {seenOnMedia.map((image, index) => (
                    <figure class="max-w-lg" key={index}>
                        <img key={index} data-aos-duration="2500" data-aos="fade-up" class="h-auto w-28 rounded-lg" src={image} alt="image description" />
                    </figure>
                ))}
            </div>
        </div>
